...
file_UTF8_name          = './UnitTest/UnitTest_UTF8.txt'
file_ASCII_name         = './UnitTest/UnitTest_ASCII.txt'
file_empty_UTF8_name    = './UnitTest/UnitTest_Empty_UTF8.txt'
file_empty_ASCII_name   = './UnitTest/UnitTest_Empty_ASCII.txt'
wrong_file_name         = './UnitTest/noneExistFile.txt'
